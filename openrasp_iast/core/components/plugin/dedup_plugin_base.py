...
class DedupPluginBase(object):
    ...
    def get_hash_str(self, rasp_result_ins):
        ...
        try:
            ...
            logger.error("Deduplicate plugin error, use default dedup algorithm, rasp_result: {}".format(
                rasp_result_ins), exc_info=e)
    ...
    def get_hash_default(self, rasp_result_ins):
        ...
        query_keys = "".join(
            sorted(rasp_result_ins.get_query_parameters().keys()))
