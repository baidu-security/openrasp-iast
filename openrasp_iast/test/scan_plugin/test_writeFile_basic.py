...
from plugin.scanner import writefile_basic
...
async def send_request(self, request_data):
    ...
    if test_param is not None and test_param.find("../../../tmp/rasp") >= 0:
...
def scan_plugin_fixture():
    ...
    plugin_ins = writefile_basic.ScanPlugin()
...
def test_normal(scan_plugin_fixture):
    ...
    "context": {
        ...
        "protocol": "http", 
        "method": "get", 
        "querystring": "test_param=/write/file", 
        "path": "/test-file.php", 
        "parameter": {
            "test_param": [
                "/write/file"
        ...
        "url": "http://localburp.com:8005/test-file.php?test_param=/write/file", 
        "nic": [
            {
                "name": "eth0", 
                "ip": "172.17.0.2"
