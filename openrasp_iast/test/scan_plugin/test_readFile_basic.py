...
from plugin.scanner import readfile_basic
...
def scan_plugin_fixture():
    ...
    plugin_ins = readfile_basic.ScanPlugin()
...
def test_normal(scan_plugin_fixture):
    ...
    "context": {
        ...
        "protocol": "http", 
        "method": "get", 
        "querystring": "test_param=/read/file", 
        "path": "/test-file.php", 
        "parameter": {
            "test_param": [
                "/read/file"
        ...
        "url": "http://localburp.com:8005/test-file.php?test_param=/read/file", 
        "nic": [
            {
                "name": "eth0", 
                "ip": "172.17.0.2"
