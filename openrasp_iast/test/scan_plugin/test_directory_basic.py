...
from plugin.scanner import directory_basic
        ...
        "hook_info": [
            {
                ...
                "realpath": "/etc", 
                "stack": [
                    "/var/www/html/vulns/001-dir.php@scandir"
                ], 
                "hook_type": "directory"
            }
        ]
...
async def send_request(self, request_data):
    ...
    if test_param is not None and test_param.find("../../../../etc") >= 0:
...
def scan_plugin_fixture():
    ...
    plugin_ins = directory_basic.ScanPlugin()
...
def test_normal(scan_plugin_fixture):
    ...
    "context": {
        ...
        "url": "http://localburp.com:8005/test-file.php?test_param=/proc", 
            "nic": [
                {
                    "name": "eth0", 
                    "ip": "172.17.0.2"
